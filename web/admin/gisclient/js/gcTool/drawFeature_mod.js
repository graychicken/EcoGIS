...
(function($, undefined) {
    ...
    $.widget("gcTool.drawFeature", $.ui.gcTool, {
        ...
        _create: function() {
            ...
            '<select style="width:auto"><option name="editing_action" value="create">'+OpenLayers.i18n('Create')+'</option>'+
            '<option name="editing_action" value="modify">'+OpenLayers.i18n('Edit')+'</option>'+
            '<option name="editing_action" value="transform">'+OpenLayers.i18n('Transform')+'</option>'+
            '<option name="editing_action" value="remove">'+OpenLayers.i18n('Delete')+'</option></select>'+
            ...
            '</div></div>'+
            '<div class="noflow" style="clear:both;"><label>&nbsp;</label><button name="editing_save" style="margin: 10px 0 0 0;">'+OpenLayers.i18n('Save')+'</button></div>'+
