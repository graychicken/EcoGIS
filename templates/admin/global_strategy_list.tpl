...
<form name="filterform" id="filterform" method="get" action="list.php">
    ...
    <div class="function_list">
        {if $USER_CAN_ADD_GLOBAL_STRATEGY}
            <input type="button" name="btnAdd" id="btnAdd" value="{t}Nuovo{/t}" onClick="addObject();" style="height:25px;width:70px;" {if $vars.can_add <> 'T'}disabled{/if} />
        {/if}
    </div>
