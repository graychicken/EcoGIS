...
<form name="filterform" id="filterform" method="get" action="list.php">
    ...
    {if $vars.parent_act!='show' and $USER_CAN_ADD_STREET_LIGHTING_CONSUMPTION}
        <div class="function_list2">
            <a href="Javascript:addConsumption({$vars.sl_id});" title="{t}Nuovo{/t}"><img src="{$smarty.const.R3_IMAGES_URL}{$smarty.const.BUILD}/ico_add_small.gif" border="0"></a>
        </div>
    {/if}
</form>
